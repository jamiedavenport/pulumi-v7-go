...
namespace JamieDavenport.V7Go
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("JamieDavenport.V7Go.version.txt");
    ...
    internal sealed class V7GoResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public V7GoResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
