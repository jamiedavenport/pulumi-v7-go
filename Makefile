PROJECT_NAME := Pulumi v7-go Resource Provider

PACK             := v7-go
PACKDIR          := sdk
PROJECT          := github.com/jamiedavenport/pulumi-v7-go
NODE_MODULE_NAME := @jamiedavenport/v7-go
NUGET_PKG_NAME   := jamiedavenport.v7-go
